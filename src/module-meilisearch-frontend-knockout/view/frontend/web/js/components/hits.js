define([
    'uiComponent',
    'Walkwizus_MeilisearchFrontendKnockout/js/model/product-model',
    'Walkwizus_MeilisearchFrontendKnockout/js/model/viewmode-state',
    'Walkwizus_MeilisearchFrontendKnockout/js/model/search-state',
    'Walkwizus_MeilisearchFrontendKnockout/js/fragments'
